...
class Profile extends StatefulWidget {
  Profile({this.customerEmail, this.isProfileEdit, this.customer});
...
class ProfileState extends State<Profile> {
  ...
  ProfileState({this.customerEmail, this.isProfileEdit, this.customer});
...
@override
  void initState() {
    if(isProfileEdit){
      ...
      _ageController.text = customer.age;
                  ...
                  child: customHomeScreenButton(
                      ...
                      function: () async {
                        if (_formKey.currentState.validate()) {
                          ...
                          _customer = Customer.fromDocument(documentSnapshot);
                          weatherData =
